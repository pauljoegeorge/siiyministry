...
import OutlookCalendar from '!file-loader!../../assets/images/common/outlookCalendar.svg'
...
const UpcomingEventContainer = () => {
  ...
  const saveToCalendar = (calendar) => {
    ...
    const eventTo = new Date(eventDateArray[0], eventDateArray[1] - 1, eventDateArray[2], to[0], to[1]).toISOString()
      ...
      <div className="pt-6">
        ...
        <div className="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
          <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            <h1 className="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl">{upcomingEvent?.title}</h1>
          </div>
          ...
          <div className="py-10 lg:pt-6 lg:pb-16 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            ...
            <div>
              ...
              <div className="space-y-6">
                <p
                  dangerouslySetInnerHTML={{ __html: upcomingEvent?.description?.replace('\n', '<br />') }}
            ...
            <div className="mt-10">
              <h3 className="text-lg font-medium text-gray-900">{upcomingEvent?.highlights?.head}</h3>
            ...
            <div className="mt-10">
              <h2 className="text-lg font-medium text-gray-900">{upcomingEvent?.moreDetails?.head}</h2>
