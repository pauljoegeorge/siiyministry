  ...
  <footer id="social" className="footer p-10 bg-neutral text-neutral-content">
    <div>
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        onClick={() => pushEvent({ ...events.onClickPrivacy() })}>
        Privacy Policy
      </a>
    </div>
    <div>
      ...
      <div className="grid grid-flow-col gap-4">
        <a
          href="https://www.facebook.com/siiym/"
          target="_blank"
          rel="noreferrer"
          onClick={() => pushEvent({ ...events.onClickSocial('facebook') })}>
          <svg
        ...
        <a
          href="https://www.instagram.com/siiyministry/"
          target="_blank"
          rel="noreferrer"
          onClick={() => pushEvent({ ...events.onClickSocial('instagram') })}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="30"
            height="30"
            fill="currentColor"
            className="bi bi-instagram hover:text-pink-600"
            viewBox="0 0 16 16">
